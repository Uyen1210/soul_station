...
<body class="font-sans antialiased bg-[#f5f5dc]"> <div class="min-h-screen flex">
        ...
        <aside class="w-64 bg-white border-r border-amber-100 shadow-lg fixed h-full z-10">
            ...
            <nav class="mt-6 px-4 space-y-2">
                <a href="{{ route('dashboard') }}" class="flex items-center px-4 py-3 text-amber-900 rounded-lg hover:bg-amber-100 transition-colors">
                ...
                <a href="{{ route('admin.books.index') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-amber-50 hover:text-amber-900 transition-colors {{ request()->routeIs('admin.books.*') ? 'bg-amber-100 font-bold' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                    <span>Quản lý Sách</span>
                </a>

                <a href="{{ route('admin.users.index') }}" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-amber-50 hover:text-amber-900 transition-colors {{ request()->routeIs('admin.users.*') ? 'bg-amber-100 font-bold' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                    <span>Quản lý Độc giả</span>
                </a>
                
                <a href="#" class="flex items-center px-4 py-3 text-gray-600 rounded-lg hover:bg-amber-50 hover:text-amber-900 transition-colors">
